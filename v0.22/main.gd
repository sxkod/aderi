...
onready var bookmarks=$pc/hmain/vcl/btnsetl/bookmarks
...
##########
#func _on_bookmarks_pressed():
#	var lbox=load("res://lbox.tscn")
#	var lboxi=lbox.instance()
#	$pc.add_child(lboxi)
#	var mpx=get_viewport().get_mouse_position()
#	mpx.x-=150
#	mpx.y+=20
#	lboxi.set_position(mpx)
#	lboxi.set_z_index(10)
#	lboxi._update_bookmarks()
#	sig.connect("bookmarksel",self,"_on_bookmark_sel")
